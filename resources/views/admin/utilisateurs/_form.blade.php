...
<div id="etudiant-fields" class="row g-3 mt-1 {{ old('role', $user?->role?->value) === 'etudiant' ? '' : 'd-none' }}">
    ...
    <div class="col-md-3">
        ...
        <input type="text" class="form-control @error('matricule') is-invalid @enderror" id="matricule" name="matricule" value="{{ old('matricule', $user?->etudiant?->matricule) }}" placeholder="ex : 1000678" pattern="\d{7}" maxlength="7" min="1000678" max="1080987">
    ...
    <div class="col-md-3">
        ...
        <input type="date" class="form-control @error('date_naissance') is-invalid @enderror" id="date_naissance" name="date_naissance" value="{{ old('date_naissance', optional($user?->etudiant?->date_naissance)->format('Y-m-d')) }}">
        @error('date_naissance') <div class="invalid-feedback">{{ $message }}</div> @enderror
    </div>
    <div class="col-md-3">
        <label for="lieu_naissance" class="form-label">Lieu de naissance</label>
        <input type="text" class="form-control @error('lieu_naissance') is-invalid @enderror" id="lieu_naissance" name="lieu_naissance" value="{{ old('lieu_naissance', $user?->etudiant?->lieu_naissance) }}">
